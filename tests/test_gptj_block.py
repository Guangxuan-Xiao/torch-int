...
def test_gptj_block():
    ...
    int8_blk = Int8GPTJBlock.from_float(
        blk, attn_input_scale, q_output_scale, k_output_scale, v_output_scale, out_input_scale, fc1_input_scale, fc2_input_scale,
        ln1_input_scale).cuda()
    int8_blk.eval()
    q_act_dict = {}
